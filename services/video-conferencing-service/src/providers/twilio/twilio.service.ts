...
export class TwilioService {
  ...
  getToken(options: TwilioSessonOptions): Promise<SessionResponse> {
    const twilioJWTToken = this.getAccessToken(options.sessionId);
  ...
  async getMeetingLink(
    ...
    const roomListInstanceCreateOptions: RoomListInstanceCreateOptions = {
      uniqueName: meetingOptions.meetingId,
